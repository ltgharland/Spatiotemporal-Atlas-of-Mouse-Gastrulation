---
title: "E6.5 seqFISH section experiment 020420"
...
```{r}
fov_info_file = "../Data/TimEmbryos-020420/slide_explorer/fovinfo.csv"
mRNA_files_dir = "../Data/TimEmbryos-020420/output/analysis/local/"
cell_files_dir = "../Data/TimEmbryos-020420/output/analysis/local/"
# segmentation_files_dir = "../Data/TimEmbryos-020420/segmentation/Segmentation/HybCycle_0/"
# segmentation_files_dir = "../Data/TimEmbryos-020420/nucleus-segmentation-020420-HybCycle0/"
segmentation_files_dir = "../Data/TimEmbryos-020420/cell-segmentation-vanilla-020420-HybCycle0/"

processed_dir = "../Data/TimEmbryos-020420/processed/"
processed_suffix = "020420"
...
```{r}
embryo_label = c(rep("embryo6", 8), rep("embryo7", 8))
names(embryo_label) <- paste0("fov.", 1:16)

Estage_label = rep("E6.5", 16)
names(Estage_label) <- paste0("fov.", 1:16)
```
...
Located in spatial_functions.R as `processSeqFISH2`.
...
long_df_names = data.frame(fov = names(tapply(long_df$x, long_df$fov, mean)),
                           x = tapply(long_df$x, long_df$fov, mean),
                           y = tapply(long_df$y, long_df$fov, mean))
...
ggplot(long_df, aes(x = x, y = -y)) + 
  ...
  NULL
print(gg)
print(gg + geom_text(aes(label = fov, x = x, y = -y),
            colour = "red", size = 5,
            data = long_df_names, inherit.aes = FALSE))
```
