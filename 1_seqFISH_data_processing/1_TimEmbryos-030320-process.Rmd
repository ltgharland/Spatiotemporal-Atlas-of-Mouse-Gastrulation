---
title: "E7.5 seqFISH section experiment 030320"
...
```{r}
fov_info_file = "../Data/TimEmbryos-030320/slide_explorer/fovinfo.csv"
mRNA_files_dir = "../Data/TimEmbryos-030320/output/analysis/local/"
cell_files_dir = "../Data/TimEmbryos-030320/output/analysis/local/"
# segmentation_files_dir = "../Data/TimEmbryos-030320/segmentation/Segmentation/HybCycle_0/"
# segmentation_files_dir = "../Data/TimEmbryos-030320/nucleus-segmentation-030320-HybCycle0/"
segmentation_files_dir = "../Data/TimEmbryos-030320/cell-segmentation-vanilla-030320-HybCycle0/"

processed_dir = "../Data/TimEmbryos-030320/processed/"
processed_suffix = "030320"
...
```{r}
embryo_label = rep("embryo4", 6)
names(embryo_label) <- paste0("fov.", 1:6)

Estage_label = rep("E7.5", 6)
names(Estage_label) <- paste0("fov.", 1:6)
```
